...
app.config['MYSQL_DATABASE_HOST'] = 'waynerds1.ctxbsfui3zxy.us-east-1.rds.amazonaws.com' # PLEASE WRITE YOUR DATABASE ENDPOINT HERE'
app.config['MYSQL_DATABASE_USER'] = 'admin'
app.config['MYSQL_DATABASE_PASSWORD'] = 'wayne12345678'
app.config['MYSQL_DATABASE_DB'] = 'wayneMySQL'
